export class consts {
  get NAMESPACE_STORAGE_KEY(): string {
...
export class KindTypes {
  ...
  static get NODES(): string {
    return 'Node'
  }
  static get PERSISTENT_VOLUMES(): string {
    return 'PersistentVolume'
  }
  static get PERSISTENT_VOLUME_CLAIMS(): string {
    return 'PersistentVolumeClaim'
  }
  static get PODS(): string {
    return 'Pod'
  }
  static get REPLICATION_CONTROLLERS(): string {
    return 'ReplicationController'
  }
  static get REPLICA_SETS(): string {
    return 'ReplicaSet'
  }
  static get RESOURCE_QUOTAS(): string {
    return 'ResourceQuota'
  }
  static get OAUTH_CLIENTS(): string {
    return 'OAuthClient'
  }
  ...
  static get SERVICE_ACCOUNTS(): string {
    return 'ServiceAccount'
  }
  static get CONFIG_MAPS(): string {
    return 'ConfigMap'
  }
  static get INGRESSES(): string {
    return 'Ingress'
  }
  ...
  static get BUILD_CONFIGS(): string {
    return 'BuildConfig'
  }
  static get BUILDS(): string {
    return 'Build'
  }
  static get DEPLOYMENT_CONFIGS(): string {
  ...
  static get IMAGE_STREAMS(): string {
    return 'ImageStream'
  }
  static get IMAGE_STREAM_TAGS(): string {
    return 'ImageStreamTag'
  }
  static get POLICIES(): string {
    return 'Policy'
  }
  static get POLICY_BINDINGS(): string {
    return 'PolicyBinding'
  }
  static get PROJECTS(): string {
    return 'Project'
  }
  static get ROLE_BINDINGS(): string {
    return 'RoleBinding'
  }
  static get ROLES(): string {
    return 'Role'
  }
  static get DAEMONSETS(): string {
    return 'DaemonSet'
  }
}
...
export class ExtensionTypes {
  static get extensions(): Array<string> {
    return [WatchTypes.DAEMONSETS, WatchTypes.DEPLOYMENTS, WatchTypes.INGRESSES, WatchTypes.REPLICA_SETS]
  }
}
