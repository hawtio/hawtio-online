...
(function (Online) {
    ...
    function addProductInfo(aboutService) {
        'ngInject';
        aboutService.addProductInfo('Hawtio Online', '1.3.1');
    }
