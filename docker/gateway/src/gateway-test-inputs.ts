    ...
    canInvokeMap: {
      ...
      response: {
        ...
        'addOrUpdateRoutesFromXml(java.lang.String)': {
          ...
          ObjectName: 'org.apache.camel:context=io.fabric8.quickstarts.karaf-camel-log-log-example-context,name="log-example-context",type=context'
        },
        'addOrUpdateRoutesFromXml(java.lang.String,boolean)': {
          CanInvoke: true,
    ...
    bulkRequestWithInterception: {
      ...
      intercepted: {
        request: [
          ...
          {
            type: 'search', mbean: 'org.apache.camel:context=*,type=routes,*'
          }
        ],
        response: [
          {
